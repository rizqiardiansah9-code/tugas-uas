<nav
    class="sticky top-0 z-50 w-full bg-app-bg/80 backdrop-blur-md h-20 flex items-center justify-between px-6 lg:px-8 shadow-lg shadow-black/20 border-b border-white/5">
    <!-- Logo -->
